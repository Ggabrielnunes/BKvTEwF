...
public class Laranja : NetworkBehaviour
{
    ...
    public void CmdAtaca()
    {
        ...
        zona.GetComponent<ParticleSystem>().Play();
    ...
    void Update()
    {
        ...
        laranja.transform.LookAt(oiala.transform);
        firerate += 1 * Time.deltaTime;
        if (recarga >= 0 && special)
        {
            special = false;
            Vortice.SendMessage("CmdAttack", false);
            Vortice.transform.position = new Vector3(8000.0f, 0.0f, 0.0f);
            recarga = -35;
        }
        if (recarga < 0)
    ...
    private void Movimentacao()
    {
        ...
        if (Input.GetKey(KeyCode.RightArrow))
        {
            ...
            oiala.transform.localPosition = new Vector3(3.0f, 0.0f, -3.0f);
            zona.transform.localPosition = new Vector3(3.8f, 0.0f, 0f);
            idle = 0;
        ...
        if (Input.GetKey(KeyCode.LeftArrow))
        {
            ...
            transform.Translate((-velocidade - (capa + 1)) * Time.deltaTime, 0, 0);
            oiala.transform.localPosition = new Vector3(-3.0f, -0.5f, -2.0f);
            zona.transform.localPosition = new Vector3(-3.8f, 0.0f, 0f);
            idle = 0;
            animacao.SetBool("Andando", true);
            animacao.SetBool("Morte", false);
        ...
        if (Input.GetButton("B"))
        {
            ...
            {
                special = true;
                Vortice.transform.position = zona.transform.position;
                Vortice.SendMessage("CmdAttack", true);
                recarga = -6;
            }
        }
